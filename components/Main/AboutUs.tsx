...
const AboutUs = () => {
  return (
    <div id="about" className=" pt-17 md:pt-40  bg-gradient-to-b from-purple-50 via-white to-purple-50 ">
       ...
       <div className="px-5 md:px-7 flex flex-col lg:flex-row  pb-15 md:pb-30 ">
         ...
         <div className="sticky top-80">
              ...
              <p className="font-heleveticaNeue font-normal text-[12px] md:text-[16px] leading-[1.4] tracking-[0.01em] text-[#570B97] mt-4 whitespace-pre-line">
