...
const AboutUsRightSection = () => {
  ...
  <div className="flex flex-col gap-4 text-[#570B97] w-full break-words">
    <p className="font-roboto font-medium text-[20px] sm:text-[24px] leading-[140%] tracking-[0.01em]">
      Subhendu Mukherjee
    </p>
    <p className="font-heleveticaNeue font-bold italic text-[14px] sm:text-[16px] leading-[140%] tracking-[0.01em]">
      Founder Director
    </p>
